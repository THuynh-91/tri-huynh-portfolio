    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center section-padding bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 overflow-hidden">
      <div className="max-w-6xl mx-auto text-center relative z-10">
        ...
        >
          ...
          >
            Building intelligent systems with machine learning and scalable backend architectures.
            Passionate about creating robust software solutions that solve real-world problems.
          </motion.p>
